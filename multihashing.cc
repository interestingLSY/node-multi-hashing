...
// DECLARE_NO_INPUT_LENGTH_CALLBACK(yespower_mgpc, yespower_mgpc_hash, 32);
...
DECLARE_FUNC(yespower_mgpc) {
    ...
    yespower_mgpc_hash(input, output, input_len);
...
DECLARE_INIT(init) {
    ...
    NODE_SET_METHOD(exports, "yespower_mgpc", yespower_mgpc);
